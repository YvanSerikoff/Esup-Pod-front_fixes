...
export const es: TranslationKeys = {
  ...
  a11y: {
    ...
    newProfilePictureSuccess: "Imagen de perfil actualizada con éxito",
    deleteProfilePictureSuccess: "Imagen de perfil eliminada con éxito",
  ...
  playlists: {
    ...
    nowPlaying: "Reproducción en curso",
